...
Paragraph: Acid-modified biochar BC-HNO3 was prepared from rice straw. The biochar was produced at 500 C for 2 h with a heating rate of 10 C/min, then treated with HNO3 (1.0 mol/L) at 60 C for 3 h. BET surface area was 412 m2/g, average pore size 3.8 nm, pore volume 0.42 cm3/g, C/O/N/H were 71.2/17.8/2.1/1.9 %, and pHpzc was 5.6.
JSON: ```JSON
[{{"meta":{{"name":"BC-HNO3", "symbol":"", "chemical formula":""}}, "biochar modification":[{{"filename":"", "sample_id":"BC-HNO3", "biomass_source":"rice straw", "pyrolysis_temp_C":"500", "hold_duration_h":"2", "heating_rate_C_min":"10", "acid_type":"HNO3", "acid_conc_mol_L":"1.0", "acid_time_h":"3", "acid_temp_C":"60", "modification_sequence":"pyrolysis->acid treatment", "SSA_m2_g":"412", "APS_nm":"3.8", "TPV_cm3_g":"0.42", "ash_percent":"", "C_percent":"71.2", "O_percent":"17.8", "N_percent":"2.1", "H_percent":"1.9", "pH_pzc":"5.6"}}]}}]
```
"""

adsorption_experiment = """
Paragraph: For methylene blue adsorption, BC-HNO3 (sample BC-HNO3) was tested at pH 7.0, 298 K, equilibrium time 120 min, and solid-liquid ratio 1.0 g/L. Qmax was not explicitly reported in this paragraph.
JSON: ```JSON
[{{"meta":{{"name":"BC-HNO3", "symbol":"", "chemical formula":""}}, "adsorption experiment":[{{"filename":"", "sample_id":"BC-HNO3", "pollutant_name":"methylene blue", "pH":"7.0", "T_K":"298", "Te_min":"120", "SLR_g_L":"1.0", "Qmax":""}}]}}]
```
"""
