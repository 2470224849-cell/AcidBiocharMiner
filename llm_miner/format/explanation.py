...
Acid-modified biochar preparation variables and physicochemical descriptors, including biomass source, pyrolysis conditions, acid treatment details, SSA, APS, PV, elemental composition, atomic ratios, and pH_pzc.
"""

adsorption_experiment = """
Adsorption test conditions and performance for pollutant removal, including C0, Qe, pH, temperature (K), equilibrium/contact time, and solid-liquid ratio.
"""
