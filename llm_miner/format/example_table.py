...
example_21 = {
    "contain": ["biochar modification"],
    "content": """
Input:
["biochar modification"],
Table X. Preparation and characterization data for acid-modified biochar.

| sample_id | biomass_source | pyrolysis_temp_C | hold_duration_h | heating_rate_C_min | acid_type | acid_conc_mol_L | acid_time_h | acid_temp_C | modification_sequence | SSA_m2_g | APS_nm | TPV_cm3_g | ash_percent | C_percent | O_percent | N_percent | H_percent | pH_pzc |
|-----------|----------------|------------------|-----------------|--------------------|-----------|-----------------|-------------|-------------|-----------------------|----------|--------|----------|-------------|-----------|-----------|-----------|-----------|--------|
| BC-HCl    | sawdust        | 500              | 2               | 10                 | HCl       | 1.0             | 3           | 60          | pyrolysis->acid treatment | 365.2 | 4.1    | 0.39     | 8.5         | 72.5      | 16.0      | 1.4       | 2.1       | 5.8    |
| BC-H2SO4  | rice husk      | 600              | 1               | 15                 | H2SO4     | 0.5             | 2           | 80          | pyrolysis->acid treatment | 420.8 | 3.5    | 0.47     | 11.2        | 68.3      | 20.5      | 1.9       | 2.0       | 4.9    |
        ...
        "biochar modification": [
            {
                ...
                "acid_time_h": "3",
                "acid_temp_C": "60",
                "modification_sequence": "pyrolysis->acid treatment",
                "SSA_m2_g": "365.2",
                "APS_nm": "4.1",
                "TPV_cm3_g": "0.39",
                "ash_percent": "8.5",
...
example_22 = {
    "contain": ["adsorption experiment"],
    "content": """
Input:
["adsorption experiment"],
Table Y. Adsorption experiment data.

| sample_id | pollutant_name | pH | T_K | Te_min | SLR_g_L | Qmax |
|-----------|----------------|----|-----|--------|---------|------|
| BC-HCl    | methylene blue | 7.0 | 298 | 120    | 1.0     |      |
| BC-H2SO4  | Pb(II)         | 5.5 | 298 | 90     | 0.5     |      |
